...
export function ExamListFilter({ isLoading }: { isLoading: boolean }) {
  ...
  const previewRenders = {
    name: {
      label: dictionary.exam.fields.name,
    },
    code: {
      label: dictionary.exam.fields.code,
    },
    isActive: {
      label: dictionary.exam.fields.isActive,
      render: dataTableFilterRenders(locale, dictionary).boolean(),
    },
    course: {
      label: dictionary.exam.fields.course,
      render: dataTableFilterRenders(locale, dictionary).relationToOne(
        courseLabel,
      ),
    },
    createdByMember: {
      label: dictionary.exam.fields.createdByMember,
      render: dataTableFilterRenders(locale, dictionary).relationToOne(
        memberLabel,
      ),
    },
    updatedByMember: {
      label: dictionary.exam.fields.updatedByMember,
      render: dataTableFilterRenders(locale, dictionary).relationToOne(
        memberLabel,
      ),
    },
    createdAtRange: {
      label: dictionary.exam.fields.createdAt,
      render: dataTableFilterRenders(locale, dictionary).dateTimeRange(),
    },
    updatedAtRange: {
      label: dictionary.exam.fields.updatedAt,
      render: dataTableFilterRenders(locale, dictionary).dateTimeRange(),
    },
    archived: {
          ...
          <FieldGroup className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <Field>
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <>
                    <Input id="code" disabled={isLoading} {...field} />
                    {fieldState.error && (
                      <FieldError>{fieldState.error.message}</FieldError>
                    )}
                  </>
            ...
            <Field>
              <FieldLabel>{dictionary.exam.fields.isActive}</FieldLabel>
              <Controller
                control={form.control}
                name="isActive"
                render={({ field, fieldState }) => (
            ...
            <Field>
              <FieldLabel>{dictionary.exam.fields.createdByMember}</FieldLabel>
              <Controller
                control={form.control}
            ...
            <Field>
              <FieldLabel>{dictionary.exam.fields.createdAt}</FieldLabel>
              <Controller
                control={form.control}
                name="createdAtRange"
                render={({ field, fieldState }) => (
            ...
            <Field>
              <FieldLabel>{dictionary.exam.fields.updatedByMember}</FieldLabel>
              <Controller
                control={form.control}
            ...
            <Field>
              <FieldLabel>{dictionary.exam.fields.updatedAt}</FieldLabel>
              <Controller
                control={form.control}
                name="updatedAtRange"
                render={({ field, fieldState }) => (
