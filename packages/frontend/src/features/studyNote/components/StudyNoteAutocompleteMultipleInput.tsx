...
export function StudyNoteAutocompleteMultipleInput({
  onChange,
  value,
  selectPlaceholder,
  searchPlaceholder,
  ...
  onChange: (
    value: Array<Partial<StudyNoteWithRelationships>> | undefined | null | [],
  ) => void;
  value?: Array<Partial<StudyNoteWithRelationships>> | null | [];
