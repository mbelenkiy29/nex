import { PasswordResetRequestFormWithRecaptcha } from '@/features/auth/components/PasswordResetRequestForm';
        ...
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl">
              {dictionary.auth.passwordResetRequest.title}
            </CardTitle>
          </CardHeader>
          <CardContent>
            <PasswordResetRequestFormWithRecaptcha locale={locale} />
            <Link
              className="mt-4 block text-center text-sm font-medium text-neutral-800 hover:underline dark:text-neutral-200"
              to="/auth/sign-in"
              preload="intent"
            >
              {dictionary.auth.passwordResetRequest.signInLink}
            </Link>
          </CardContent>
        </Card>
      </div>
