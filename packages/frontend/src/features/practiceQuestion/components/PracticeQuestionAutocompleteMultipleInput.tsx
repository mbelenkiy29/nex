...
export function PracticeQuestionAutocompleteMultipleInput({
  onChange,
  value,
  selectPlaceholder,
  searchPlaceholder,
  ...
  onChange: (
    value:
      | Array<Partial<PracticeQuestionWithRelationships>>
      | undefined
      | null
      | [],
  ) => void;
  value?: Array<Partial<PracticeQuestionWithRelationships>> | null | [];
      ...
      {isFormOpen && (
        <PracticeQuestionFormSheet
          ...
          onSuccess={(practiceQuestion) => {
            setIsFormOpen(false);
            onChange([...(value || []), practiceQuestion]);
          }}
        />
      )}
    </div>
